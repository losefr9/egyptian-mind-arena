-- حذف الـ trigger المعتمد على الدالة أولاً
DROP TRIGGER IF EXISTS cleanup_queue_trigger ON player_queue;

-- حذف الدالة القديمة
DROP FUNCTION IF EXISTS public.cleanup_old_queue_entries() CASCADE;
