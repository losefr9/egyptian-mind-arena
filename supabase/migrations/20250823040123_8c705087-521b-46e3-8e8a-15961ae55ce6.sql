-- إضافة دالة لتوليد أسئلة رياضية عشوائية
...
-- تحديث دالة الحصول على سؤال عشوائي لتستخدم التوليد العشوائي
...
-- تحديث دالة التحقق من الإجابة للعمل مع الأسئلة المولدة عشوائياً
...
BEGIN
  -- تحليل نص السؤال
  -- نفترض أن السؤال بالشكل: "5 + 3 = ؟" أو "4 × 2 = ؟"
